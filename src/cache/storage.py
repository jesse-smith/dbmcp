...
class DocumentationStorage:
    ...
    def export_documentation(
        ...
        for schema in schemas:
            ...
            for table in schema_tables:
                ...
                table_content = self._generate_table_doc(
                    table,
                    table_columns,
                    table_indexes,
                    table_declared,
        ...
        relationships_content = self._generate_relationships_doc(
            declared_fks,
    ...
    def _generate_table_doc(
        ...
        schema_name = table.schema_id  # schema_id is actually schema_name
        lines = [
    ...
    def _generate_relationships_doc(
        self,
        declared_fks: list[DeclaredFK],
        inferred_fks: list[InferredFK],
    ) -> str:
