...
**Plans:** 6 plans (expanded from 5 per D-14 — find_pk/fk_candidates now namespace-aware → 7 tools total)

Plans:
- [ ] 15-01-PLAN.md — Add default_schema + max_identifier_depth properties to DialectStrategy + 3 impls (IDENT-03/07)
- [ ] 15-02-PLAN.md — dbo signature sweep in MetadataService/QueryService (SC4 service half, IDENT-07)
- [ ] 15-03-PLAN.md — TDD: resolve_identifier + ResolvedIdentifier + shared catalog-gate in src/db/identifiers.py (IDENT-03/04/07)
- [ ] 15-04-PLAN.md — Route 3 schema tools through resolver/shared gate; drop dbo; catalog Ignored→rejected (IDENT-03/04/07)
- [ ] 15-05-PLAN.md — Add catalog to get_sample_data + get_column_info; resolver routing; SC3 3-part SQL (IDENT-05/06)
